### Updates
#### Nov 1, 2024:
Currently, we do not support Ubuntu 24 due to some incompatibility issues between the system and `aider`, more information [in this issue](https://github.com/commit-0/commit0/issues/85)
